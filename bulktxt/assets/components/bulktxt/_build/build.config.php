...
$menu->fromArray(array(
    ...
    'menuindex' => '0',
    'params' => '',
    'handler' => '/manager/?a=index&namespace=bulktxt',
), '', true, true);
...
/* function '<?php ?>' remover, for clean snippets and plugins imports */
...
$vehicle->resolve('file', array(
    ...
    'options' => array(
        'chmod' => '0755', // Set the desired directory permissions
    ),
));
